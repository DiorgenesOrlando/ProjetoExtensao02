...
import com.example.coletorjetpackcompose.view.QrCodeAnalyzer
                ...
                factory = { context ->
                    ...
                    imageAnalysis.setAnalyzer(
                        ...
                        QrCodeAnalyzer { result ->
                            code = result
                            entradaDados.entradaDadosUiState.value.dados.destino = uiState.copy(
                                dados = uiState.dados.copy(
                                    destino = code
                                )
                            ).toString()
